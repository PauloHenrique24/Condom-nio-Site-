...
if ($_POST) {
    ...
    if (empty($cpf) || empty($senha)) {
        ...
        $stmt = $conn->prepare("
            SELECT m.*, c.nome as condominio_nome 
            FROM moradores m 
        ...
        if ($row = $result->fetch_assoc()) {
            ...
            if (password_verify($senha, $row['senha'])) {
                ...
                $_SESSION['morador_id'] = $row['id'];
                $_SESSION['morador_nome'] = $row['nome'];
                $_SESSION['condominio_id'] = $row['condominio_id'];
                $_SESSION['condominio_nome'] = $row['condominio_nome'];
                $_SESSION['bloco'] = $row['bloco'];
                $_SESSION['apartamento'] = $row['apartamento'];
...
<body>
    <div class="container">
        <div class="header">
            <h1>Login Morador</h1>
            <p>Acesse sua conta para visualizar serviços e solicitações</p>
        </div>
        ...
        <div class="content">
            ...
            <div class="info-card">
                <p>Utilize seu CPF e senha cadastrados para acessar o sistema</p>
            </div>
            ...
            <div class="register-link">
                <a href="cadastro_morador.php">Não tem conta? Cadastre-se aqui</a>
            </div>
